...
const Eigen::ThreadPoolDevice* CreateThreadPoolDevice(int num_threads) {
  LazyEigenThreadPoolHolder* thread_pool_holder =
      new LazyEigenThreadPoolHolder(num_threads);
  return thread_pool_holder->GetThreadPoolDevice();
}
